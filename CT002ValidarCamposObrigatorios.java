...
public class CT002ValidarCamposObrigatorios {
  ...
  @Test
  public void testCT002ValidarCamposObrigatorios() throws Exception {
    // Acessa a URL
    ...
    assertEquals(driver.findElement(By.cssSelector("div.form-feedback-item")).getText(), "This field is required.");
  }
